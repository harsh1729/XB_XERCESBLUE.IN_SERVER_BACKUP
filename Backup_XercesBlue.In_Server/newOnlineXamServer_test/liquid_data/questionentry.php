...
<div class="container-fluid" id="one">
    ...
    <div class="row" style="margin-top:20px;">
        <div class="col-lg-8 col-md-8">
            Enter The pretext:-<textarea class="form-control lang_class" onpaste="getpretext()"  rows="10" name="pretext" id="pretext" style="resize:none;"></textarea>
				...
				success:function(response)
				{
                    ...
                    $('#pretext_select').append($('<option style="width:100px;">').text('select pre text').prop('value',''));                
               		for(i=0;i<response.length;i++)
                       {
                            ...
                            $('#pretext_select').append($('<option style="width:100px;">').text("["+response[i].id+"] "+response[i].text).prop('value',response[i].id));                
                       }
...
$('#pretext_select').on('change', function (e) {
	 ...
	 if(z !== 0)
	 {
		 $('#pretext').val(fullpretext[z-1].full_text);
	 }
});
