...
if(isset( $_GET['QuesId'] ))
{
   ...
   while($getQuestionRow = mysql_fetch_array( $getQuestionResult ) )
    {
        ...
        $cat_re = mysql_query($cat_q);
        while($cat_r = mysql_fetch_array($cat_re))
        {
            $cat =  $cat_r['QuesCatId'];   
        }
       ...
       echo "<div class='container-fluid'>";
        ...
        while( $getOptionsRow = mysql_fetch_array($getOptionsResult) )
        {
