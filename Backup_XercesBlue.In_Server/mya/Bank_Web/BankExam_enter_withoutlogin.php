...
<div class="container-fluid" id="main_container">
	<div class="row" style="margin-top:50px;">
        ...
        <div class="col-md-2">
        	<div id="demo_exam_button" class="btn btn-block btn-lg btn-default well">Demo Exam</div>
        </div>
        <div class="col-md-5">
        </div>
    ...
    <div class="row" >
        ...
        <div class="col-md-4" style="color:#F00;">
         	<p>if you take a exam than you logged in first otherwise you take demo by clicking the Deme
            Exam Button </p>
        </div>
        <div class="col-md-4">
        </div>
...
$(document).ready(function(e) {
    $('#demo_exam_button').click(function(){
		window.open('Front_end_demo_instruction.php','mywindow','"menubar=1,resizable=1,width='+W+',height='+H+'"');
	});
});
</script>
</body>
