 ...
 <div id="virtual_result"  style=" width:450px; display:none;overflow:auto;text-align:left;padding:10px;margin-left:34%;border:1px solid black;"></div>
 			<div id="main_window_div">
                        ...
                        <div id="Exam_Buttons_pannale">
										...
										<div id = 'exam_restart_exit_div'  style="background-color:white;border:solid 1px gray;position:absolute; bottom:1px; left:0;text-align:center; display:none; width:98.4%; padding:8px"><a href="Front_end_Demo.php" > <input type='button' value='Restart exam' onclick="restart()" style='height:30px; cursor:pointer;padding:0px 3px; margin-right:40px;'/></a><input type='button' value='exit' id="exit_button" style='height:30px;width:80px; cursor:pointer;'/> </div>	
    					</div>
