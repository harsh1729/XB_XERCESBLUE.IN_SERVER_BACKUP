        ...
        <script>
			...
			function updatePosts()
			{
				...
				//if(totalPosts > document.getElementById('TotalPost').value)
				{
					...
					+"Total Seats: <input type='text' name='TotalSeats"+(i+1)+"' value='1'/>"
...
//			$("#"+lastElementId+(count+1)+"Div").after(btnRow);
    ...
    <body>
    	<form action="sumitXamAlert.php" method="post" >
        <!--		XamAlert_Details_Test			--->
        	ExamName: <input type="text" placeholder="Exam Name" name="XamName" /><br />
            Opening Date: <input type="date" name="OpeningDate" placeholder="Opening_Date"/><br />
            Offline Last Date: <input type="date" name="OfflineLastDate" placeholder="Offline last Date"/> <br />
            Online Last Date: <input type="date" name="OnlineLastDate" placeholder="Online last Date" /><br />
            Total Post: <input type="number" min="1" max="20" name="TotalPost" id="TotalPost" value="1" onchange="updatePosts()"><br />
       	<!--		XamAlert_Details_Test			--->
        <br />
        <div id="postContainer">
            ...
            <br />
                ...
                Total Seats: <input type="text" name="TotalSeats1" value="1"/>
            ...
            <!--		XamAlert_Dates_Test			-->
                ...
                <input type="button" value=" Delete Exam Date " onclick="RemoveXamDate('PostName1RemoveBtn','PostName1XamDate',1)" id="PostName1RemoveBtn"/>
