...
/////       http://www.xercesblue.in/onlinexamserver/liquid_data/test_xml.php?lastQuestionNumber=0&appId=1
...
$qus_query = "select * from ( select * from qrecord as t2 where t2.QuesId in ( select t1.QuesId from qusappmapping as t1 where t1.AppId = ".$id_of_app." ) ) as t3 where t3.QuesId > ".$id_of_last_qus."  limit ".$TotalLimit;
