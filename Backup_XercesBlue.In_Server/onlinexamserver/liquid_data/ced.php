...
<body>
        ...
        <div id="Addcatemain">
            ...
            <div id="AddLanguage">
           	   <form action="add_new_language.php" method="post">
                    ...
                    <br>
                    <input name="language_textfield" type="text" id="AddText" class="pop_up_text_field" placeholder="Enter New Language">
                    <input type="submit" value="Add" id="AddcateBtn" class="Addbutton">
                </form>
            </div>
        </div>
        ...
        <form action="question_submit.php" method="get">
             <div id="catagari">
                ...
                <select name="Language_select_option">
                <?php
				$qry = "select * from Language";
				//$lan_result = mysql_query($qry) or die(mysql_error());
				$lan_result = $db->query($qry) or die(mysql_error($db));
...
<!--		          <textarea rows="7" cols="30" name="txtarea" id="question_text"></textarea><br>-->
                  ...
                  <textarea rows="7" cols="30" name="ced" id="ced"></textarea><br>
	        ...
	        <div id="third">      
    	     ...
    	     <div id="submit">
				...
				andar	<select id="language" onChange="check_value(this.value)" name="language" style="margin-top:50px;">
					</select>
