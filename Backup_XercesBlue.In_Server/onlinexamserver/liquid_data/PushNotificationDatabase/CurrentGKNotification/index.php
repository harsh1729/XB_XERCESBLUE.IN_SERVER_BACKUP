...
?>
    <form action="gcm_engine.php" method="post">
       ...
       <!--  <label for="SelectAll">Select All</label>
        ...
        <br>
        <!--    AIzaSyBVWLvw5ikZaN5XSNf2BLZCCz-NZLtQlSo     onlineexam project server key   AIzaSyBt9X6gSwzN9eAdsz3FJQ_XXJRrDnIczwo -->
        <input type="text" id="apikey" name="apiKey" value="AIzaSyBt9X6gSwzN9eAdsz3FJQ_XXJRrDnIczwo" readonly/>
        <br>
        <br>
        <textarea name="heading" id="heading" placeholder="Heading" rows="3" cols="70"></textarea>
         <br>
        <br>
        <textarea name="message" id="message" placeholder="Message" rows="7" cols="70"></textarea>
        <br>
