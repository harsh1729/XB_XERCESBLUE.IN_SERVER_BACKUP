<div class="row">
	...
	<div class="col-sm-3">
			...
			<?php foreach ($all_daily_test[0] as $index => $row) : ?>
				...
				<div class="text-center daily_curren_gk_test_name" data-date="<?=$row?>" style="color:#faa519;padding:10px;">
					&gt; Daily Current GK Quiz <?=$day?>-<?=$month_name?>-<?=$year	?>
				</div>
				<?php } else { ?>
					
					<div class="text-center daily_curren_gk_test_name" data-testno="<?=$row['test_no']?>" data-category="<?=$row['category']?>" data-date="<?=$row['date']?>" style="color:#faa519;padding:10px;">
		...
		<div class="row">
			<div class="col-sm-9" style="padding-left:0px;padding-right:0px;">
					...
					<div style="width:100%;height:500px;margin-top:22px;border:1px solid #eee;">
						...
						<div style="height:380px;width:100%;overflow:auto;" class="question_pannel">	
			...
			<div class="col-sm-3" style="">
				<div style="background-color:#e4edf7;height:500px;margin-top:45px;overflow:auto;">
