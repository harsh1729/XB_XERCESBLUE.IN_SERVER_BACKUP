...
<div class="container-fluid" style="background-color:#fff;">
  ...
  <div class="row" id="adjustsize" style="background-color:#7ADBF0;color:#fff;">
     <!-- <div class="col-xs-1">
    ...
    <div class="col-md-10 col-sm-10 col-xs-12" >
       <?php if($this->session->userdata('is_logged_in')) { ?>
        <div id="menu_container" style="height:75px;background-color:#7ADBF0;color:#fff;display:none;" >
              ...
              <div id="custom_acount" class="text-center" style=" width:100%;background-color:#faa519;position:absolute;display:none;z-index:2;">
                <a href="<?=base_url()?>Bankpo/results" style="color:#fff;text-decoration:none;">
                  ...
                  <a href="<?=base_url()?>Bankpo/bankposetpdf" style="text-decoration:none;color:#fff;">
                    <div class="" style="padding:7px 0px;display:none;" >
                      Videos
                    </div>
                  </a>  
            ...
            <div class="custom_menu video" style="height:75px;cursor:pointer;position:relative;border-top:10px solid #8063C5;float:right;">
              <div style="height:65px; width:100%;background-color:#8063C5;position:absolute;display:none;">
              
              </div>
              <div class="" data-controller="Bankpo/video" style="height:65px;letter-spacing:-2px;z-index:2;font-size:20px;position:relative;padding:15px 25px;">
                Videos
              </div>
          ...
          <div id="menu_container" style="height:75px;background-color:#7ADBF0;color:#fff;display:none;" >
            ...
            <div class="custom_menu my_account" style="cursor:pointer;height:65px;position:relative;border-top:10px solid #faa519;float:right;">
              <div id="custom_acount" class="text-center" style=" width:100%;background-color:#faa519;position:absolute;display:none;z-index:2;">
                    ...
                    <div class="not_logged_in" data-controller="Bankpo/video" style="padding:7px 0px;display:none;" >
                      Videos
                    </div>
            ...
            <div class="custom_menu video" style="height:75px;cursor:pointer;position:relative;border-top:10px solid #8063C5;float:right;">
              ...
              <div class="not_logged_in" data-controller="Bankpo/video" style="height:65px;letter-spacing:-2px;z-index:2;font-size:20px;position:relative;padding:15px 25px;">
                Videos
              </div>
