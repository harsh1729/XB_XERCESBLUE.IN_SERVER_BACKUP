...
<div class="row" style="overflow:hidden;background-color:;">
	...
	<div class="col-md-10" id="bankpo_home" style="margin-top:35px;">
	   
		<div class="row">
			<div class="col-md-5 nicescroll" id="bank_test_container_scroll" style="height:550px;overflow-y:auto;overflow-x:hidden;">
			...
			<div class="col-md-3" style="height:520px;">
				<div style="height:520px;overflow-y:auto;overflow-x:hidden;">
						...
						width="100%"  src="https://www.youtube.com/embed/PaKtLxA1LD0"
					frameborder="0" allowFullScreen="true"></iframe>
						
					</div>
					<div id="advertisement" style="height:50%;width:100%;background-color:#7519D1;margin-top:10px;">
