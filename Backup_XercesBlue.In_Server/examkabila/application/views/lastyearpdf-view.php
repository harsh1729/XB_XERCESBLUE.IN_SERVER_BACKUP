...
<div class="row" style="margin-top:35px;overflow:hidden;">
	...
	<div class="col-md-10" id="bankpo_home">
		...
		<div class="row">
			<div class="col-md-9 nicescroll"  id="lastyear_pdf_container" style="height:520px; overflow-x:hidden;overflow-y:auto;">
						...
						<div class='row' style='display:hidden;margin-bottom:10px;'>
							<div class='col-sm-12'>
									<div style='height:130px;padding-top:22px;cursor:pointer;border:1px solid #ccc;' id="practice_set_<?=$count?>"   class='test_gradiant center_container '>
										...
										<div style='color:#0080c0;font-size:24px;margin-left:130px;line-height:1em;letter-spacing:-2px;word-spacing:5px;'>Last Year Paper Set PDF <?= $count?></div>
										...
										<div style="margin-left:130px;margin-top:13px;font-size:16px;">20/-</div>
										<button type="button" class="btn btn-lg btn-info add_cart" style="bottom:10px;right:25px;position:absolute;"   data-type="<?= $row['set_info_type'] ?>" data-price="<?= $price?>"   data-itemid="<?=$row['set_info_id'] ?>">Download</button>
						...
						<div class='row' style='display:hidden;margin-bottom:10px;'>
							<div class='col-sm-12'>
									<div style='height:130px;padding-top:22px;cursor:pointer;border:1px solid #ccc;' id="practice_set_<?=$count?>"   class='test_gradiant center_container '>
										...
										<div style='color:#000;font-size:18px;margin-left:130px;margin-top:5px; line-height:1em;font-family:Times New Roman, Times, serif;'>As per IBPS exam Format </div>
										<div style="margin-left:130px;margin-top:13px;font-size:16px;">20/-</div>
										<button type="button" class="btn btn-lg btn-info add_cart" style="bottom:10px;right:25px;position:absolute;" data-name="Last Year Pepar PDF"  data-settype="<?= $row['set_info_type'] ?>" data-price="<?= $price?>"   data-itemid="<?=$row['set_info_id'] ?>">Buy</button>
