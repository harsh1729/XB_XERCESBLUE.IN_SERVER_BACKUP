<?php
	...
	class Bankpo_model extends CI_Model
	{
		...
		function get_all_pdf($type,$userid)
    	{
			...
			$this->db->select('pdf_table.id as pdf_id,pdf_table.amount as pdf_amount,pdf_table.pay_type as pdf_pay_type,pdf_table.item_id as pdf_item_id, pdf_table.type as pdf_type,pdf_table.name as pdf_name,pdf_table.date as pdf_date,pdf_table.isactive_pre,pdf_table.isactive_main, user_setpurchage_mapping.type as set_type, user_setpurchage_mapping.item_id as item_id , user_setpurchage_mapping.userid as userid');
