	...
	<div class="container-fluid">
    	...
    	<div class="row" style="margin-top:100px;" id="main_container">
            ...
            <div class="col-md-4" style="border:1px solid #000;border-radius:5px;">
                ...
                <div class="row" style="margin-bottom:20px;">
                	<div class="col-md-12">
                    	From:<input type="date" class="form-control" required="required" id="from" name="date_from" min="2015-01-01">
                    </div>
                </div>
                <div class="row" style="margin-bottom:20px;">
                	<div class="col-md-12">
                    	To:<input type="date" class="form-control" 	 required="required" id="to" name="date_to" min="2015-01-01">
                    </div>
                </div>
