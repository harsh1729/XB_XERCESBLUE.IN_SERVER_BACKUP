jQuery(document).ready(function($){
   jQuery('.switch_options').each(function() {
    ...
    $('#accordion-panel-wimpie_lite_general_settings').prepend(
        '<div class="user_sticky_note">'+
        '<h3 class="sticky_title">Need help?</h3>'+
        '<span class="sticky_info_row"><label class="row-element">View demo: </label> <a href="http://8degreethemes.com/demo/wimpie-lite/" target="_blank">here</a>'+
        '<span class="sticky_info_row"><label class="row-element">View documentation: </label><a href="http://8degreethemes.com/documentation/wimpie-lite/" target="_blank">here</a></span>'+
        '<span class="sticky_info_row"><label class="row-element">Support forum: </label><a href="https://8degreethemes.com/support/forum/wimpie-lite/" target="_blnak">here</a></span>'+
