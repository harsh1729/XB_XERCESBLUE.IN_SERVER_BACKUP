...
function wimpie_lite_custom_customize_register( $wp_customize ) {
  ...
  //$wp_customize->get_section('nav')->panel = 'wimpie_lite_general_settings'; //priority 100 //removed from wordpress 4.3
  $wp_customize->get_section('static_front_page')->panel = 'wimpie_lite_general_settings'; //priority 120

  //have default favicon in 4.3
  //Uncomment below if you are using version less than 4.3
  //Favicon Settings
  // $wp_customize->add_section('wimpie_lite_favicon_setting', array(
  //   'priority' => 10,
  //   'title' => __('Favicon Settings', 'wimpie-lite'),
  //   'panel' => 'wimpie_lite_general_settings'
  //   ));

  // $wp_customize->add_setting('wimpie_lite_favicon_upload', array(
  //   'default' => '',
  //   'capability' => 'edit_theme_options',
  //   'sanitize_callback' => 'esc_url_raw'
  //   ));

  // $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'wimpie_lite_favicon_upload', array(
  //   'label' => __('Upload favicon for your site', 'wimpie-lite'),
  //   'section' => 'wimpie_lite_favicon_setting',
  //   'setting' => 'wimpie_lite_favicon_upload'
  //   )));
  ...
  $wp_customize->add_control( new WP_Customize_Category_Control( $wp_customize,'wimpie_lite_slider_setting_category', array(
 ...
 $wp_customize->add_control( new WP_Customize_Category_Control( $wp_customize,'wimpie_lite_services_setting_category', array(
 ...
 $wp_customize->add_control( new WP_Customize_Category_Control( $wp_customize,'wimpie_lite_awesome_feature_setting_category', array(
 ...
 $wp_customize->add_control( new WP_Customize_Category_Control( $wp_customize,'wimpie_lite_portfolio_setting_category', array(
 ...
 $wp_customize->add_control( new WP_Customize_Category_Control( $wp_customize,'wimpie_lite_teammember_setting_category', array(
 ...
 $wp_customize->add_control( new WP_Customize_Category_Control( $wp_customize,'wimpie_lite_clientlogo_category_setting', array(
 ...
 $wp_customize->add_control( new WP_Customize_Category_Control( $wp_customize,'wimpie_lite_blog_setting_category', array(
...
//text color h2
 ...
 $wp_customize->add_section( 'wimpielite_custom_tools' , array(
  ...
  //custom css
 $wp_customize->add_setting('wimpielite_custom_tools_css',array(
  'default' => '',
  'sanitize_callback' => 'wimpie_lite_sanitize_text',
  ));
 
 $wp_customize->add_control('wimpielite_custom_tools_css',array(
  'type' => 'textarea',
  'label' => __('Custom Css','wimpie-lite'),
